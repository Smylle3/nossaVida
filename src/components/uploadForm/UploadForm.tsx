		...
		<div className="formContainer">
			{loading >= 0 ?
				<div className="progress" >
					{loading != 100 ?
						<>
							<Circle percent={loading} strokeWidth={6} strokeColor="#845EC2" trailColor="#B0A8B9" />
				...
				<form onSubmit={handleSubmit} className="myForm">
					{previewUrl ? (
						...
						<>
							...
							<input onChange={handleFileChange} type='file' accept='image/png, image/jpeg' id="fileInput" className="inputFile" />
							<label htmlFor="fileInput" className="customFileInput">
								<BsCloudUploadFill />Ou selecione uma imagem <BsCloudUploadFill />
							</label>
						</>
					}
				</form>}
